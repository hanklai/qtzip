...
#include "../../../quazip-0.7.3/qztest/testquazipdir.h"
...
void TestQuaZipDir::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        TestQuaZipDir *_t = static_cast<TestQuaZipDir *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject TestQuaZipDir::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TestQuaZipDir.data,
      qt_meta_data_TestQuaZipDir,  qt_static_metacall, nullptr, nullptr}
};
