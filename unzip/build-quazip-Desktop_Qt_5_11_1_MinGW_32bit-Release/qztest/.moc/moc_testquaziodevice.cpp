...
#include "../../../quazip-0.7.3/qztest/testquaziodevice.h"
...
void TestQuaZIODevice::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        TestQuaZIODevice *_t = static_cast<TestQuaZIODevice *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject TestQuaZIODevice::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TestQuaZIODevice.data,
      qt_meta_data_TestQuaZIODevice,  qt_static_metacall, nullptr, nullptr}
};
