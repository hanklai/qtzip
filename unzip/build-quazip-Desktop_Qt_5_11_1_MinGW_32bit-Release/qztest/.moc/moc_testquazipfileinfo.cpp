...
#include "../../../quazip-0.7.3/qztest/testquazipfileinfo.h"
...
QT_MOC_LITERAL(2, 31, 0) // ""
    ...
    "TestQuaZipFileInfo\0getNTFSTime\0"
};
...
void TestQuaZipFileInfo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        TestQuaZipFileInfo *_t = static_cast<TestQuaZipFileInfo *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject TestQuaZipFileInfo::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TestQuaZipFileInfo.data,
      qt_meta_data_TestQuaZipFileInfo,  qt_static_metacall, nullptr, nullptr}
};
