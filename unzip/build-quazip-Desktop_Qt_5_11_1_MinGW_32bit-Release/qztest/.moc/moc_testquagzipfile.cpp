...
#include "../../../quazip-0.7.3/qztest/testquagzipfile.h"
...
void TestQuaGzipFile::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        TestQuaGzipFile *_t = static_cast<TestQuaGzipFile *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject TestQuaGzipFile::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TestQuaGzipFile.data,
      qt_meta_data_TestQuaGzipFile,  qt_static_metacall, nullptr, nullptr}
};
